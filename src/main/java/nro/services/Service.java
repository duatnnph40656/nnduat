    ...
    public void chat(Player player, String text) {
        if (player.getSession() != null && player.isAdmin()) {
            ...
            if (text.equals("admin")) {
                String str = "";
                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, -1, "Count " + Manager.DOMAIN + " Server. " + "Số lượng người chơi hiện tại: " + Client.gI().getPlayers().size() + "\n" + str, "Ngọc rồng", "Đệ tử", "Bảo trì", "Tìm kiếm\nngười chơi", "Cập Nhật\nThông Báo", "Đóng");
                return;
