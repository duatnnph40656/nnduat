                ...
                switch (this.select) {
                    case 0:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            InventoryService.gI().addItemBag(playerSummonShenron, ctGohan);
                            InventoryService.gI().sendItemBags(playerSummonShenron);
                        } else {
                            Service.getInstance().sendThongBao(playerSummonShenron, "Hành trang đã đầy");
                            reOpenShenronWishes(playerSummonShenron);
                    ...
                    case 1:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            InventoryService.gI().addItemBag(playerSummonShenron, ctBiden);
                            InventoryService.gI().sendItemBags(playerSummonShenron);
                        } else {
                            Service.getInstance().sendThongBao(playerSummonShenron, "Hành trang đã đầy");
                            reOpenShenronWishes(playerSummonShenron);
                    ...
                    case 2:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            InventoryService.gI().addItemBag(playerSummonShenron, ctConuong);
                            InventoryService.gI().sendItemBags(playerSummonShenron);
                        } else {
                            Service.getInstance().sendThongBao(playerSummonShenron, "Hành trang đã đầy");
                            reOpenShenronWishes(playerSummonShenron);
                    ...
                    case 3:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            InventoryService.gI().addItemBag(playerSummonShenron, PetThoOm);
                            InventoryService.gI().sendItemBags(playerSummonShenron);
                        } else {
                            Service.getInstance().sendThongBao(playerSummonShenron, "Hành trang đã đầy");
                            reOpenShenronWishes(playerSummonShenron);
                    ...
                    case 4:
                        if (InventoryService.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            InventoryService.gI().addItemBag(playerSummonShenron, PetThoMap);
                            InventoryService.gI().sendItemBags(playerSummonShenron);
                        } else {
                            Service.getInstance().sendThongBao(playerSummonShenron, "Hành trang đã đầy");
                            reOpenShenronWishes(playerSummonShenron);
