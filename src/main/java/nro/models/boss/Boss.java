...
//                itemMap = new ItemMap(this.zone, ConstItem.MANH_GIAY, Util.nextInt(1, 3), x, y, player.id);
//                itemMap = new ItemMap(this.zone, ConstItem.MANH_QUAN, Util.nextInt(1, 3), x, y, player.id);
//                itemMap = new ItemMap(this.zone, ConstItem.MANH_AO, Util.nextInt(1, 3), x, y, player.id);
//                itemMap = new ItemMap(this.zone, ConstItem.MANH_GANG_TAY, Util.nextInt(1, 3), x, y, player.id);
